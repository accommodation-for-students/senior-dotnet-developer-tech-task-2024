...
namespace AFS.TechTask.Properties.Ingest.Models
{
    ...
    public record PropertyIngestResult(DateTime Run, bool Success, IReadOnlyCollection<Property> ValidProperties, IReadOnlyCollection<InvalidPropertyIngest> InvalidProperties)
    {
        /// <summary>
